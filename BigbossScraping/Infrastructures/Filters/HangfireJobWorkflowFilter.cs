...
namespace BigbossScraping.Infrastructures.Filters
{
    ...
    public class PostExceptionFilter : IActionFilter
    {
    ...
    public class HangfireJobWorkflowFilter : JobFilterAttribute,
        IClientFilter, IServerFilter, IElectStateFilter, IApplyStateFilter
    {
        ...
        {
            Logger.InfoFormat("Starting to perform job `{0}` `{1}`", context.BackgroundJob.Id,
